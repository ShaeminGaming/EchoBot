...
const commands = [
  new SlashCommandBuilder()
    ...
    .addSubcommand((s) => s.setName("list").setDescription("List all echo links in this server."))
    .addSubcommand((s) =>
      s
        .setName("off")
...
async function main() {
  ...
  // ✅ Global deploy (works for all servers the bot is in)
  await rest.put(Routes.applicationCommands(CLIENT_ID), { body: commands });

  console.log("✅ Global slash commands deployed. (May take up to ~1 hour to appear everywhere.)");
}
